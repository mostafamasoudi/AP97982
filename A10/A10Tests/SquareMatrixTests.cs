...
namespace A10Tests
{
    ...
    public class SquareMatrixTests
    {
        ...
        public void AddExceptionTest()
        {
            ...
            SquareMatrix<int> m2 = new SquareMatrix<int>(1)
            {
                new Vector<int>(1) { 0},
            };
        ...
        {
            SquareMatrix<int> m1 = new SquareMatrix<int>(5)
            {
                new Vector<int>(Enumerable.Repeat(1, 5)),
                new Vector<int>(Enumerable.Repeat(0, 5)),
                new Vector<int>(Enumerable.Repeat(0, 5)),
                new Vector<int>(Enumerable.Repeat(0, 5)),
                new Vector<int>(Enumerable.Repeat(0, 5)),
            };
            ...
            SquareMatrix<int> m2 = new SquareMatrix<int>(
                Enumerable.Repeat(new Vector<int>(5) { 1, 0, 0, 0, 0 }, 5)
                );

            var m3 = m1 * m2;

            Assert.AreEqual(5, m3[0, 0]);
        ...
        public void EqualsTest()
        {
            ...
            Matrix<int> m4 = new SquareMatrix<int>(3)
            {
